...
?>
    <div id="respond">
      <div style="overflow: hidden;">
        <p style="float: right;" id='{{$data->claim_id}}'>
          <?php
      ...
      <div style="overflow: hidden;">
        ...
        <p style="margin-left: 30%;">{{$data->claim_id}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Claim by:</b></p>
        <p style="margin-left: 30%;">{{$data->username}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Claim:</b></p>
        <p style="margin-left: 30%;">{{$data->description}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Can you Reproduce?:</b></p>
        <p style="margin-left: 30%;">{{$data->can_reproduce}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Source Code:</b></p>
        <p style="margin-left: 30%;">{{$data->source_code}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Datasets:</b></p>
        <p style="margin-left: 30%;">{{$data->datasets}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Experiments and results:</b></p>
        <p style="margin-left: 30%;">{{$data->exp_results}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>Claimed at:</b></p>
        <p style="margin-left: 30%;">{{$data->created_at}}</p>
      </div>

      <div style="overflow: hidden;">
        <p style="float: left;"><b>email:</b></p>
        <p style="margin-left: 30%;">{{$data->email}}</p>
      </div>
    </div>
<?php 
}
