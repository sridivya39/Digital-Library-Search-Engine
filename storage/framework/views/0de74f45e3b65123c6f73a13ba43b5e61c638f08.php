...
<li class="nav-item">
<a class="nav-link" href="<?php echo e(route('MainController')); ?>"><?php echo e(__('Login')); ?></a>
</li>
<?php endif; ?>
...
<br>
<br>
<form action="<?php echo e(URL::to('/main/process_advsearch')); ?>" method="POST">
<?php echo e(csrf_field()); ?>
...
$("body").unmark().mark("<?php echo e($param ?? ''); ?>"); 
}
});
